...
export const Container = styled.div`
  ...
  width: min(601px, 100%); /** container irá aumentar sua largura
  até 601 px, Acima disso ele não irá aumentar sua largura.
  Obtenho o valor mínimo entre a largura da tela e 601px
  */
...
export const BottomMenu = styled.div`
  ...
  @media (min-width: 500px) { /** Acima de 500px, o bottom-menu some. */
    display: none;
  }
`;
